...
import {
  ...
  useDirection,
  useId
} from "./chunk-DO7MSRGR.js";
import {
  usePrevious,
  useSize
} from "./chunk-MR3WXCJG.js";
import {
  composeEventHandlers,
  createContextScope,
  useControllableState,
  useLayoutEffect2
} from "./chunk-CMJSOBGY.js";
import {
  composeRefs,
  useComposedRefs
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  const Slot8 = createSlot2(`Primitive.${node}`);
...
var PopperAnchor = React13.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime10.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React16.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime13.jsx)(Primitive4.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React17.Children.count(newElement) > 1)
      ...
      return (0, import_jsx_runtime14.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var SelectIcon = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive5.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
...
var SelectContent = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      const frag = fragment;
      return frag ? ReactDOM9.createPortal(
...
var Slot7 = createSlot5("SelectContent.RemoveScroll");
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime19.jsx)(Combination_default, { as: Slot7, allowPinchZoom: true, children: (0, import_jsx_runtime19.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectGroup = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime19.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime19.jsx)(Primitive5.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive5.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      (0, import_jsx_runtime19.jsx)(Primitive5.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren ? ReactDOM9.createPortal(itemTextProps.children, context.valueNode) : null
    ] });
  }
);
...
var SelectItemIndicator = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime19.jsx)(Primitive5.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Primitive5.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
